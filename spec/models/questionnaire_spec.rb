...
RSpec.describe Questionnaire, type: :model do
  questionnaire = FactoryBot.create(:questionnaire) do |questionnaire_new|
    FactoryBot.create_list(:session, 2, questionnaire: questionnaire_new)
    FactoryBot.create_list(:question, 2, questionnaires: [questionnaire_new])
  end
