...
RSpec.describe Session, type: :model do
  ...
  session = FactoryBot.create(:session) do |session|
    FactoryBot.create_list(:given_answer, 2, session:session, answer:answer)
    FactoryBot.create_list(:session_user, 2, session:session)
  end
